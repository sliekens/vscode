...
import { startClient, LanguageClientConstructor, AsyncDisposable } from '../xmlClient';
...
export async function activate(context: ExtensionContext) {
	...
	const serverMain = `./server/${clientPackageJSON.main.indexOf('/dist/') !== -1 ? 'dist' : 'out'}/node/xmlServerMain`;
